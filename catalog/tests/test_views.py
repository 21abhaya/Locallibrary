...
class LoanedBookInstancesByUserListViewTest(TestCase):
    ...
    #tests that verify our view only returns books that are on loan to our current borrower
...
class AuthorCreateViewTest(TestCase):
    ...
    def setUp(self):
        ...
        #print("SSS: ",content_typeAuthor)
        permAddAuthor = Permission.objects.get(
            codename="add_author",
            content_type=content_typeAuthor,
        )
        #print("PERM: ", permAddAuthor)
    ...
    def test_logged_in_with_and_has_permission(self):
    ...
    def test_if_initial_death_date_is_correct(self):
        login = self.client.login(username='test_user', password='some_password')
        response = self.client.get(reverse('author-create'))
        self.assertEqual(response.status_code, 200)
    ...
    def test_redirects_to_detail_view_on_success(self):
        login = self.client.login(username='test_user', password='some_password')
        response = self.client.post(reverse('author-create'),{'first_name': 'Author', 'last_name':'Fortest'})
        self.assertEqual(response.status_code, 302)
