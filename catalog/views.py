...
def index(request):
    ...
    # Generate counts of books with 'and' in the title
...
class BookInstanceListView(generic.ListView):
    """Generic class-based list view for a list of Bookinstances."""
    model = BookInstance
    paginate_by = 10
